...
function calcularContagemRegressiva() {
    ...
    var meses = Math.floor(diferencaMilissegundos / (1000 * 60 * 60 * 24 * 30.44)); // Média de dias por mês
    var semanas = Math.floor((diferencaMilissegundos % (1000 * 60 * 60 * 24 * 30.44)) / (1000 * 60 * 60 * 24 * 7));
    var dias = Math.floor((diferencaMilissegundos % (1000 * 60 * 60 * 24 * 7)) / (1000 * 60 * 60 * 24));
    var horas = Math.floor((diferencaMilissegundos % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
    var minutos = Math.floor((diferencaMilissegundos % (1000 * 60 * 60)) / (1000 * 60));
    ...
    document.getElementById("contagemRegressiva").innerHTML =
        "Meses: " + meses + " | Semanas: " + semanas + " | Dias: " + dias +
...
calcularContagemRegressiva();
  ...
  function gerarMensagemAleatoria() {
    ...
    for (var i = 0; i < numPartes; i++) {
      var parteAleatoria = partesMensagem[Math.floor(Math.random() * partesMensagem.length)];
...
function alternarGaleria() {
    ...
    if (galeriaVisivel) {
        ...
        document.getElementById("botaoGaleria").textContent = "Acessar Galeria Para você se lembrar de alguns momentos.";
    }
}
